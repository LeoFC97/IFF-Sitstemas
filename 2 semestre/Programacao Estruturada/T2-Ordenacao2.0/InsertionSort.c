...
int main()
{
  ...
  output_tempo=fopen("Relatorio_Insertion_Sort.txt","w");
  if(inputA==NULL)
  {
...
void imprimir(int vetor[],int fim)
{
  ...
  if(fim==tamA)
  {
  outputA=fopen("A_Ordenado_Inertion_Sort.txt","w");
  ...
  if(fim==tamB)
  {
  outputB=fopen("B_Ordenado_Insertion_Sort.txt","w");
  ...
  if(fim==tamC)
  {
  outputC=fopen("C_Ordenado_Insertion_Sort.txt","w");
  ...
  if(fim==tamD)
  {
  outputD=fopen("D_Ordenado_Insertion_Sort.txt","w");
